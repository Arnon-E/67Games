...
const kScoringConfig = (
  maxScore: 1000,
  xpDivisor: 10,
  // Exponential decay per ms: score = 1000 × exp(−decay × deviationMs)
  // Chosen so that 50 ms off scores ~6× more than 600 ms off.
  deviationDecay: 0.00326,
);
