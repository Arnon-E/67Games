...
const _items = [
  _Item(id: 'timer_skin_neon', nameKey: 'neonTimer', descKey: 'neonTimerDesc',
      price: 1000, categoryKey: 'timerSkins', equipType: 'timerSkin', color: Color(0xFF00FFCC)),
  _Item(id: 'timer_skin_gold', nameKey: 'goldTimer', descKey: 'goldTimerDesc',
      price: 2500, categoryKey: 'timerSkins', equipType: 'timerSkin', color: Color(0xFFFFD700)),
  _Item(id: 'bg_purple', nameKey: 'purpleHaze', descKey: 'purpleHazeDesc',
      price: 1500, categoryKey: 'backgrounds', equipType: 'background', color: Color(0xFF8B5CF6)),
  _Item(id: 'bg_ocean', nameKey: 'oceanDeep', descKey: 'oceanDeepDesc',
      price: 1500, categoryKey: 'backgrounds', equipType: 'background', color: Color(0xFF0EA5E9)),
